...
class AddCategory extends React.Component {
    ...
    async submitCategory() {
        ...
        if(resp.status===200){
            ...
            this.setState({ alert: true,alertmessage:'Added successfully' })
            this.loadCategory()
    ...
    render() {
        return <div>
            ...
            <Paper elevation={0} className=" padding almostwhitebg" >
                ...
                <TextField required id="catdesc" label="Category description" multiline variant="outlined" className="whitebg w-50 marginrit " />
            ...
            <Paper elevation={0} className="padding almostwhitebg">
                ...
                <br /> <br />
                <TextField required onChange={this.writeSubCategoryName.bind(this)} label="Subcategory name " variant="outlined" className="whitebg marginrit w-100" />
                <br /> <br />
                <TextField required onChange={this.writeSubCategoryDesc.bind(this)} label="Subcategory description " multiline variant="outlined" className="whitebg w-100 marginrit " />
                <br /> <br />
